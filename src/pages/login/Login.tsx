			...
			<div className="flex justify-center items-center w-full h-full px-8 lg:px-0">
				...
				>
					...
					<div className="text-center mb-4">
						<h2 className="text-5xl mb-2 bg-gradient-to-r from-red-600 to-red-800 bg-clip-text text-transparent">
							Entrar
						</h2>
					...
					<button
						type="submit"
						disabled={isLoading}
						className="rounded-xl bg-gradient-to-r from-red-600 to-red-700 flex justify-center items-center
							hover:from-red-700 hover:to-red-900 active:scale-95

...
function Cadastro() {
	...
	return (
		<div className="grid grid-cols-1 lg:grid-cols-2 h-screen place-items-center font-bold bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden">
			...
			<div
				style={{
					backgroundImage: `url("https://ik.imagekit.io/vzr6ryejm/food/fundo06_2.jpeg?updatedAt=1729749014094")`,
				}}
				className="lg:block hidden bg-no-repeat w-full h-screen bg-cover bg-center relative
					...
					before:from-red-600/20 before:to-transparent"
			>
			...
			<div className="flex justify-center items-center w-full h-screen px-6 lg:px-12">
				...
				>
					...
					<div className="text-center mb-2">
						<h2 className="text-4xl mb-2 bg-gradient-to-r from-red-600 to-red-700 bg-clip-text text-transparent">
							Cadastrar
						</h2>
					...
					<div className="flex justify-between gap-4 w-full mt-3">
						...
						<button
							type="submit"
							disabled={isLoading}
							className="rounded-lg bg-gradient-to-r from-red-600 to-red-700 flex justify-center items-center
